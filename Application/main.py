...
def map():
    ...
    crimetype = tweets[1]
    location = tweets[2]
    return render_template("home.html",name = 'new_plot', url ='static\images\mew_plot.png',options = options,selected=selected,desc=desc,crimetype=crimetype,location=location)
